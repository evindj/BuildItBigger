...
package com.example.evindj.jokes.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends JokeApiRequest<com.example.evindj.jokes.backend.jokeApi.model.RemoteJoke> {

    private static final String REST_PATH = "remotejoke";
     ...
     */
    protected GetJoke() {
      super(JokeApi.this, "GET", REST_PATH, null, com.example.evindj.jokes.backend.jokeApi.model.RemoteJoke.class);
    }
